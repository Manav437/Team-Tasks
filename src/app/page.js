                ...
                <div className="relative group">
                    ...
                    <Image
                        className="relative border border-white/20 p-1.5 bg-white/10 backdrop-blur-sm shadow-2xl rounded-2xl
                                   transition-transform duration-700 ease-out group-hover:scale-[1.01] group-hover:-translate-y-1"
                        height={500}
                        width={900}
            ...
            <section className="flex flex-col items-center justify-center w-full mt-16 mb-16 px-4">
                <div className="max-w-xl w-full flex flex-col items-center gap-6">
                    ...
                    <button
                        ...
                        className="group flex items-center gap-2 cursor-pointer text-base ring-2 ring-black/30 px-8 py-4 rounded-2xl bg-black/80 text-white hover:bg-[#2c2c2c] font-semibold shadow transition"
                    >
                        GET STARTED
                        <PiArrowRight className="text-xl transition-transform duration-300 ease-in-out group-hover:translate-x-0.5" />
                    </button>
                </div>
            </section>
