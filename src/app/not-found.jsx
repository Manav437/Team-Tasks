...
export default function NotFound() {
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-[url('/landing-page-bg.png')] px-4">
            <div className="bg-white rounded-2xl shadow-lg p-8 max-w-md w-full flex flex-col items-center">
                ...
                <p className="text-slate-600 mb-8 text-center">
                    Oops! This page took a wrong turn at <a className='text-indigo-500 hover:text-indigo-400 underline' target='_blank' href="https://en.wikipedia.org/wiki/Breaking_Bad">Albuquerque.</a> <br />
