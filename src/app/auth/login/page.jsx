...
export default function LoginPage() {
    ...
    return (
        <div className="login min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-indigo-50 to-white">
            <div className="login-container bg-white rounded-xl shadow-lg p-8 w-full max-w-md">
                <div className="Login-div flex flex-col items-center">
                    ...
                    />
                    <h1 className="login-header text-2xl font-bold text-[#36465D] mb-2">Log in to TaskTeams</h1>
                    <p className="login-p mb-4 text-slate-600">
                    ...
                    <form className="login-form w-full" onSubmit={handleSubmit}>
                        ...
                        <label className="label-text block mb-1 text-slate-700">Email</label>
                        <input
                            className="login-input w-full px-3 py-2 mb-4 border border-slate-300 rounded"
                            type="email"
                            name="email"
                            value={form.email}
                        ...
                        <label className="label-text block mb-1 text-slate-700">Password</label>
                        <input
                            className="login-input w-full px-3 py-2 mb-4 border border-slate-300 rounded"
                            type="password"
                            name="password"
