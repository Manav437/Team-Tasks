// app/auth/signup/page.jsx (or wherever your SignUp component is)
"use client";
            ...
            <div className="relative z-10 w-24/25 max-w-md mx-auto">
                <div className="bg-white/70 backdrop-blur-md rounded-2xl shadow-2xl p-8">
                    <div className="flex flex-col items-center">
                        ...
                        />
                        <h1 className="text-2xl font-bold text-[#36465D] mb-2">Sign up for TaskTeams</h1>
                        <p className="mb-4 text-slate-600">
                            Already have an account?{" "}
                            <Link className="text-green-600 font-semibold hover:underline" href="/auth/login">
                                Log in
                            </Link>
                        </p>
                        ...
                        >
                            ...
                            <span className="text-[#fff] font-medium">Sign up with Google</span>
                        </button>
